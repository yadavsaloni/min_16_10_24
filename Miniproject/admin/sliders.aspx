<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sliders.aspx.cs" Inherits="Miniproject.admin.sliders" %>
            ...
            <div class="row" style="border-right-bottom: 2px solid; height: 660px;">
                <div class="col-sm-3" style="border: 2px solid; box-shadow: 5px 3px 2px gray;">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active  text-dark" aria-current="page" href="#"  style="box-shadow:2px 4px gray;">Dashboard</a>
                        </li>
                        <hr />
                        <li class="nav-item">
                            <a class="nav-link  text-dark" href="Dashborad.aspx" style="box-shadow:2px 4px gray;">Users</a>
                        </li>
                        <hr />
                            ...
                            <table class="table table-bordered" style="border:1px solid black; " id="myTable">
                                ...
                                <tbody>
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <tr>
                                            <td><%#Eval("id") %></td>
                                            <td><img src='../uploads/<%# Eval("photoname") %>' style="height:100px;" /></td>      
                                            <td><%#Eval("status") %></td>
                                            <td><%#Eval("datetime") %></td>
                                            <td><a href='#' onclick='deletedata(<%# Eval("id") %>)'>Delete</a></td>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <asp:FileUpload runat="server" ID="photoname" CssClass="form-control" ></asp:FileUpload><br />
          <asp:Button ID="slideradd" runat="server" Text="upload" CssClass="btn btn-success" OnClick="slideradd_Click"  />
      </div>
