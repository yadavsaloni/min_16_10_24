<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs" Inherits="Miniproject.ResetPassword" %>
            ...
            <div class="row" style="height: 500px;">
                ...
                <div class="col-sm-6 p-3 mt-5">
                    <div class="card" style="box-shadow: 2px 5px 4px gray;">
                       ...
                       <p style="text-shadow:2px 3px 5px blue; font-size:25px;"> Reset password form</p>
                            </marquee>
                 ...
                 <div>
                     <asp:TextBox runat="server" ID="t1" CssClass="form-control"></asp:TextBox>
                            ...
                            <div>
                     <asp:TextBox runat="server" ID="t2" CssClass="form-control"></asp:TextBox>
                                
                            </div>
                            <br />
                            <!-- <a href="#" class="btn btn-primary">Go somewhere</a>-->
                            <asp:Button ID="btn8" runat="server" CssClass="btn btn-success" OnClick="btn8_Click" Text="Reset Password" />
                        </div>
                    </div>
                    <div class="col-sm-3"></div>
                </div>
